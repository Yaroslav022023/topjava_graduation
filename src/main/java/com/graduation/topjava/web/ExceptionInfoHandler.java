...
import com.graduation.topjava.util.ValidationUtil;
import com.graduation.topjava.util.exception.*;
...
import static com.graduation.topjava.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo votingRestriction(HttpServletRequest req, VotingRestrictionsException e) {
        return logAndGetErrorInfo(req, e, false, VOTING_RESTRICTIONS);
    }
